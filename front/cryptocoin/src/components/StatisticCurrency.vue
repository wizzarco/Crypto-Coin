<template>
    <div data-aos="zoom-in" data-aos-delay="200" data-aos-once="true" class="max-w-8xl mx-auto bg-white shadow-lg relative z-20 mt-8 hidden md:block">
                    ...
                    <table class="items-center bg-transparent w-full border-collapse ">
                        ...
                        <thead>
                            <tr>
                                ...
                                <th class="px-6 bg-sky-50 text-sky-500 align-middle border border-solid border-sky-100 py-3 text-xs uppercase border-l-0 border-r-0 whitespace-nowrap font-semibold text-left">24h %</th>
                                <th class="px-6 bg-sky-50 text-sky-500 align-middle border border-solid border-sky-100 py-3 text-xs uppercase border-l-0 border-r-0 whitespace-nowrap font-semibold text-left">7d %</th>
                                ...
                                <th class="px-6 bg-sky-50 text-sky-500 align-middle border border-solid border-sky-100 py-3 text-xs uppercase border-l-0 border-r-0 whitespace-nowrap font-semibold text-left">Circulating Supply</th>
                        ...
                        <tbody>
                            <tr v-for="cryptocurrency in cryptocurrencies" class="hover:bg-gray-100">
                                <td class="border-t-0 border border-solid border-sky-100 px-6 align-center border-l-0 border-r-0 text-sm whitespace-nowrap p-4">{{ cryptocurrency.rank }}</td>
                                ...
                                <td class="border-t-0 border border-solid border-sky-100 px-6 align-center border-l-0 border-r-0 text-sm whitespace-nowrap p-4">{{ cryptocurrency.price }}</td>
                                <td class="border-t-0 border border-solid border-sky-100 px-6 align-center border-l-0 border-r-0 text-sm whitespace-nowrap p-4"><i class="fas fa-arrow-down text-red-500 mr-4"></i>{{ cryptocurrency.volumehour }}</td>
                                <td class="border-t-0 border border-solid border-sky-100 px-6 align-center border-l-0 border-r-0 text-sm whitespace-nowrap p-4"><i class="fas fa-arrow-up text-emerald-500 mr-4"></i>{{ cryptocurrency.volume24h }}</td>
                                <td class="border-t-0 border border-solid border-sky-100 px-6 align-center border-l-0 border-r-0 text-sm whitespace-nowrap p-4"><i class="fas fa-arrow-down text-red-500 mr-4"></i>{{ cryptocurrency.volumeday }}</td>
                                <td class="border-t-0 border border-solid border-sky-100 px-6 align-center border-l-0 border-r-0 text-sm whitespace-nowrap p-4">{{ cryptocurrency.top24h }}</td>
                                <td class="border-t-0 border border-solid border-sky-100 px-6 align-center border-l-0 border-r-0 text-sm whitespace-nowrap p-4">{{ cryptocurrency.maxsupply }}</td>
                                <td class="border-t-0 border border-solid border-sky-100 x-6 align-center border-l-0 border-r-0 text-sm whitespace-nowrap p-4">À faire</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
